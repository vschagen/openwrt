...
static int mtk_xfrm_add_state(struct net_device *dev,
                              struct xfrm_state *x,
                              struct netlink_ext_ack *extack);

static void mtk_xfrm_del_state(struct net_device *dev,
                                struct xfrm_state *x);

static void mtk_xfrm_free_state(struct net_device *dev,
                                struct xfrm_state *x);
...
{
    printk("register netdev notifier");
...
{
	xfrm_unregister_netdevice_notifier(&ipsec_dev_notifier);
}
/*
